  ...
  features: [
    {
      title: "Smart Recommendations",
      description:
        "Personalized apartment suggestions based on your specific needs and preferences.",
    },
    {
      title: "Comprehensive Listings",
      description:
        "Detailed information about each apartment with high-quality photos and virtual tours.",
    },
    {
      title: "AI-Powered Matching",
      description:
        "Our intelligent algorithm finds apartments that truly match your lifestyle.",
    },
    {
      title: "Easy Application",
      description:
        "Streamlined application process with all necessary documents in one place.",
    },
  ],
  mission:
    "Our mission is to transform the apartment hunting experience by leveraging technology to create perfect matches between people and their homes, saving time and reducing stress in finding the ideal living space.",
  process: [
    "Create your preference profile including budget, location, amenities, and lifestyle factors",
    "Our AI analyzes thousands of listings to find your best matches",
    "Review personalized apartment suggestions with detailed compatibility scores",
...
// Apartment filter and sort options
export const filterOptions = {
  neighborhoods: ["Downtown", "Midtown", "West End", "East Side"],
  amenities: ["In-unit Washer/Dryer", "Gym", "Pool", "Parking"],
  sortOptions: ["Best Match", "Lowest Price", "Highest Match"],
};
    ...
    questions: [
      {
        ...
        question: "How does HomeFit's matching algorithm work?",
        answer:
          "Our proprietary matching algorithm analyzes over 50 different variables including your budget, commute preferences, lifestyle needs, and amenity requirements...",
      },
      {
        id: "faq2",
        question: "Is HomeFit completely free to use?",
      ...
      },
      {
        ...
        question: "How up-to-date are your apartment listings?",
        answer:
          "We sync our database with property management systems multiple times per day...",
      },
      {
        id: "faq4",
        question: "Can I save apartments to view later?",
        answer:
          "Yes, you can save unlimited properties to your favorites list...",
      },
      {
        id: "faq5",
        question: "Does HomeFit handle the rental application process?",
        answer:
          "For select partner properties, you can complete the entire application process...",
      },
      {
        id: "faq6",
        question:
          "What makes HomeFit different from other apartment finding services?",
        answer:
          "Unlike general listing sites, HomeFit focuses on quality matches...",
      },
      {
        id: "faq7",
        question: "How do I schedule a viewing through HomeFit?",
        answer:
          "Once you've found a property you'd like to see, simply click the 'Schedule Viewing' button...",
      },
      {
        id: "faq8",
        question: "Can HomeFit help me find roommates?",
  ...
  questions: [
    {
      ...
      question: "How do I list a new apartment?",
      answer:
        "Navigate to the Broker Dashboard and click on 'Add New Listing'. Fill out the required details and submit the form.",
    },
    {
      id: "broker2",
      question: "How can I track the performance of my listings?",
      answer:
        "In the Broker Dashboard, go to 'My Listings' to view metrics like views, match scores, and saved counts.",
    },
    {
      id: "broker3",
      question: "Can I edit or delete a listing after it's published?",
      answer:
        "Yes, go to 'My Listings', choose the listing you want to modify, and select the edit or delete option.",
    },
  ],
};
  ...
  questions: [
    {
      ...
      question: "How do I get apartment recommendations?",
      answer:
        "After logging in, you can set your preferences through our preferences form. Once your preferences are saved, you'll receive personalized apartment recommendations based on your criteria.",
    },
    {
      id: "panel2",
      question: "Can I update my preferences after submitting them?",
      answer:
        "Yes, you can update your preferences at any time. Simply navigate to the 'Set Your Preferences' section and update your existing preferences or create new ones.",
    },
    {
      id: "panel3",
      question: "I'm a broker, how can I list apartments?",
      answer:
        "If you have a broker account, you'll see a 'List Apartment' option on your home page. Click on it to add new properties to our listings.",
    },
    {
      id: "panel4",
      question: "How does the matching system work?",
      answer:
        "Our algorithm matches your preferences with available properties in our database. We consider factors like location, budget, amenities, and other criteria you've specified to find the best matches for you.",
    },
    {
      id: "panel5",
      question: "How can I contact a broker about a property?",
      answer:
        "When viewing property details, you'll find contact information for the listing broker. You can reach out directly through the provided contact methods.",
    },
  ],
};
